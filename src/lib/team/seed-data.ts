...
export const TEAM_CATEGORIES_META: Record<string, TeamCategoryMeta> = {
  pi: {
    id: "pi",
    label: "Principal Investigator & Lab Director",
    shortLabel: "Principal Investigator",
    description: "Lab directorship, scientific oversight, academic mentorship, and strategic research vision.",
    badgeColor: "bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border-emerald-500/30",
  },
  undergraduate: {
    id: "undergraduate",
    label: "Undergraduate Fellows & Assistants",
    shortLabel: "Undergraduate Members",
    description: "Undergraduate researchers gaining immersive training in ecotoxicology assays and environmental field sampling.",
    badgeColor: "bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 border-indigo-500/30",
  },
  graduate: {
    id: "graduate",
    label: "Graduate Researchers (M.Sc. & M.S.)",
    shortLabel: "Graduate Members",
    description: "Master of Science students conducting advanced analytical laboratory and computational thesis research.",
    badgeColor: "bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 border-cyan-500/30",
  },
  phd: {
    id: "phd",
    label: "Postdoctoral & PhD Researchers (Postdoc, Ph.D., M.Phil)",
    shortLabel: "Postdoc & PhD",
    description: "Doctoral candidates and postdoctoral scientists conducting independent hypothesis-driven research.",
    badgeColor: "bg-teal-500/10 text-teal-600 dark:text-teal-400 border-teal-500/30",
  },
  alumni: {
    id: "alumni",
    label: "Lab Alumni Network",
    shortLabel: "Alumni Network",
    description: "Former researchers and trainees advancing environmental science in academia, government agencies, and industry.",
...
export const INITIAL_TEAM_MEMBERS: TeamMember[] = [
  ...
  // ==========================================
  {
    ...
    slug: "dr-mohammad-s-kabir",
    role: "Professor & Principal Investigator",
    category: "pi",
    department: "Department of Environmental Sciences",
    affiliation: "Jahangirnagar University",
    bio: "Dr. Mohammad S. Kabir is a Professor of Environmental Ecotoxicology and Founding Director of the Environmental Health & Ecotoxicology Laboratory at Jahangirnagar University. With over two decades of experience in environmental chemistry and molecular toxicology, his research focuses on the environmental fate, bioaccumulation kinetics, and human health risks associated with persistent organic pollutants (POPs), per- and polyfluoroalkyl substances (PFAS), microplastics, and heavy metal cocktails in freshwater and estuarine ecosystems.",
    ...
    googleScholarUrl: "https://scholar.google.com/citations?user=example-kabir",
    orcid: "0000-0002-8419-7201",
    researchGateUrl: "https://www.researchgate.net/profile/Mohammad-Kabir",
    linkedinUrl: "https://linkedin.com/in/mohammad-kabir-ecotox",
    imageSrc: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=800&q=80",
    imageAlt: "Dr. Mohammad S. Kabir - Professor & Principal Investigator",
    ...
    cvUrl: "#view-cv",
    curriculumVitae: {
      title: "Curriculum Vitae — Prof. Dr. Mohammad S. Kabir",
  ...
  },
  {
    ...
    education: [
      "Postdoctoral Fellow, Environmental Health & Ecotox Lab (2021 – 2024)",
